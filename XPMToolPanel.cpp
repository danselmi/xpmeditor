...
XPMToolPanel::XPMToolPanel(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size, wxColour cHotSpotColour)
{
	...
	BoxSizer2->Add(SelectButton, 0, wxALL|wxEXPAND, 2);
	...
	BoxSizer2->Add(LassoButton, 0, wxALL|wxEXPAND, 2);
	...
	BoxSizer2->Add(PipetteButton, 0, wxALL|wxEXPAND, 2);
	...
	BoxSizer2->Add(LineButton, 0, wxALL|wxEXPAND, 2);
	...
	BoxSizer2->Add(CurveButton, 0, wxALL|wxEXPAND, 2);
	ToolButtonsSizer->Add(BoxSizer2, 0, wxALL|wxEXPAND, 0);
	...
	BoxSizer5->Add(PenButton, 0, wxALL|wxEXPAND, 2);
	...
	BoxSizer5->Add(BrushButton, 0, wxALL|wxEXPAND, 2);
	...
	BoxSizer5->Add(FillButton, 0, wxALL|wxEXPAND, 2);
	...
	BoxSizer5->Add(SprayCanButton, 0, wxALL|wxALIGN_BOTTOM, 2);
	...
	BoxSizer5->Add(GradientButton, 0, wxALL|wxALIGN_BOTTOM, 2);
	ToolButtonsSizer->Add(BoxSizer5, 0, wxALL|wxEXPAND, 0);
	...
	BoxSizer7->Add(TextButton, 0, wxALL|wxEXPAND, 2);
	...
	BoxSizer7->Add(RectangleButton, 0, wxALL|wxEXPAND, 2);
	...
	BoxSizer7->Add(PolygonButton, 0, wxALL|wxEXPAND, 2);
	...
	BoxSizer7->Add(EllipseButton, 0, wxALL|wxEXPAND, 2);
	...
	BoxSizer7->Add(RRectButton, 0, wxALL|wxEXPAND, 2);
	ToolButtonsSizer->Add(BoxSizer7, 0, wxALL|wxEXPAND, 0);
	...
	BoxSizer10->Add(EraserButton, 0, wxALL|wxEXPAND, 2);
	...
	BoxSizer10->Add(HotSpotButton, 0, wxALL|wxALIGN_BOTTOM, 2);
	ToolButtonsSizer->Add(BoxSizer10, 0, wxALL|wxEXPAND, 0);
	ToolPanelSizer->Add(ToolButtonsSizer, 0, wxALL|wxEXPAND, 0);
	ToolPanelSizer->Add(118,5,0, wxALL|wxEXPAND, 1);
	...
	BrushToolSizer->Add(ComboBrushTool, 0, wxALL|wxEXPAND, 2);
	ToolPanelSizer->Add(BrushToolSizer, 0, wxALL|wxEXPAND, 0);
	...
	ColourPickerSizer->Add(HotSpotColourPicker, 0, wxALL|wxEXPAND, 2);
	ToolPanelSizer->Add(ColourPickerSizer, 0, wxALL|wxEXPAND, 0);
	...
	SizeSizer->Add(StaticText4, 0, wxALL|wxALIGN_LEFT, 2);
	...
	SizeSizer->Add(SpinCtrl1, 1, wxALL|wxEXPAND, 2);
	ToolPanelSizer->Add(SizeSizer, 0, wxALL|wxEXPAND, 0);
	...
	RadiusSizer->Add(StaticText6, 0, wxALL|wxALIGN_LEFT, 2);
	...
	RadiusSizer->Add(SpinCtrl3, 1, wxALL|wxEXPAND, 2);
	ToolPanelSizer->Add(RadiusSizer, 0, wxALL|wxEXPAND, 0);
	...
	ThicknessSizer->Add(StaticText5, 0, wxALL|wxALIGN_LEFT, 2);
	...
	ThicknessSizer->Add(SpinCtrl2, 1, wxALL|wxEXPAND, 2);
	ToolPanelSizer->Add(ThicknessSizer, 0, wxALL|wxEXPAND, 0);
	FontSizer = new wxBoxSizer(wxVERTICAL);
	StaticBoxSizer1 = new wxStaticBoxSizer(wxVERTICAL, this, _("Alignment"));
	BoxSizer4 = new wxBoxSizer(wxHORIZONTAL);
	BoxSizer4->Add(1,1,1, wxALL|wxEXPAND, 2);
	...
	BoxSizer4->Add(TopLeft, 0, wxALL|wxALIGN_TOP, 1);
	...
	BoxSizer4->Add(TopCenter, 0, wxTOP|wxLEFT|wxRIGHT|wxALIGN_TOP, 1);
	...
	BoxSizer4->Add(TopRight, 0, wxTOP|wxLEFT|wxRIGHT|wxALIGN_TOP, 1);
	BoxSizer4->Add(1,1,1, wxALL|wxEXPAND, 2);
	StaticBoxSizer1->Add(BoxSizer4, 0, wxALL|wxEXPAND, 0);
	BoxSizer9 = new wxBoxSizer(wxHORIZONTAL);
	BoxSizer9->Add(1,1,1, wxALL|wxEXPAND, 2);
	...
	BoxSizer9->Add(CenterLeft, 0, wxLEFT|wxRIGHT|wxALIGN_CENTER_VERTICAL, 1);
	...
	BoxSizer9->Add(CenterRight, 0, wxLEFT|wxRIGHT|wxALIGN_CENTER_VERTICAL, 1);
	BoxSizer9->Add(1,1,1, wxALL|wxEXPAND, 2);
	StaticBoxSizer1->Add(BoxSizer9, 0, wxALL|wxEXPAND, 0);
	BoxSizer11 = new wxBoxSizer(wxHORIZONTAL);
	BoxSizer11->Add(1,1,1, wxALL|wxEXPAND, 2);
	...
	BoxSizer11->Add(BottomLeft, 0, wxBOTTOM|wxLEFT|wxRIGHT|wxALIGN_BOTTOM, 1);
	...
	BoxSizer11->Add(BottomCenter, 0, wxBOTTOM|wxLEFT|wxRIGHT|wxALIGN_BOTTOM, 1);
	...
	BoxSizer11->Add(BottomRight, 0, wxBOTTOM|wxLEFT|wxRIGHT|wxALIGN_BOTTOM, 1);
	BoxSizer11->Add(1,1,1, wxALL|wxEXPAND, 2);
	StaticBoxSizer1->Add(BoxSizer11, 0, wxALL|wxEXPAND, 0);
	FontSizer->Add(StaticBoxSizer1, 0, wxALL|wxEXPAND, 0);
	...
	BoxSizer12->Add(BackgroundButton, 0, wxALL|wxEXPAND, 5);
	...
	BoxSizer12->Add(FontButton, 0, wxALL|wxEXPAND, 5);
	FontSizer->Add(BoxSizer12, 0, wxALL|wxEXPAND, 0);
	BoxSizer3 = new wxBoxSizer(wxVERTICAL);
	StaticText8 = new wxStaticText(this, ID_STATICTEXT9, _("Angle (deg):"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT9"));
	BoxSizer3->Add(StaticText8, 0, wxALL|wxALIGN_LEFT, 2);
	...
	BoxSizer3->Add(SpinAngle, 0, wxALL|wxEXPAND, 2);
	FontSizer->Add(BoxSizer3, 0, wxALL|wxEXPAND, 0);
	ToolPanelSizer->Add(FontSizer, 0, wxALL|wxEXPAND, 2);
	...
	PenStyleSizer->Add(StaticText1, 0, wxALL|wxALIGN_LEFT, 2);
	ComboPenStyle = new wxBitmapComboBox(this,ID_CUSTOM1, _(""),wxDefaultPosition,wxDefaultSize, 0, NULL, wxCB_READONLY);
	PenStyleSizer->Add(ComboPenStyle, 1, wxALL|wxEXPAND, 2);
	ToolPanelSizer->Add(PenStyleSizer, 0, wxALL|wxEXPAND, 0);
	...
	BrushStyleSizer->Add(StaticText2, 0, wxALL|wxALIGN_LEFT, 2);
	ComboBrushStyle = new wxBitmapComboBox(this,ID_CUSTOM3, _(""),wxDefaultPosition,wxDefaultSize, 0, NULL, wxCB_READONLY );
	BrushStyleSizer->Add(ComboBrushStyle, 1, wxALL|wxEXPAND, 2);
	ToolPanelSizer->Add(BrushStyleSizer, 0, wxALL|wxEXPAND, 0);
	...
	GradientSizer->Add(ChoiceGradientDirection, 0, wxALL|wxEXPAND, 2);
	ToolPanelSizer->Add(GradientSizer, 0, wxALL|wxEXPAND, 0);
	ToolPanelSizer->Add(118,5,0, wxALL|wxEXPAND, 1);
...
void XPMToolPanel::HideControlsAndDoLayout(int iIndex, bool bChecked)
{
    ...
    //this redraw code is necessary because some borders of wxCustomButton are not updated
    //this is a quick & dirty fix and would need better investigation so here it is :
    /// \todo : investigate wxCustomButton draw problem
    Refresh(false, NULL);
    Update();
