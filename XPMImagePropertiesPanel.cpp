...
XPMImagePropertiesPanel::XPMImagePropertiesPanel(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	Choice1->SetToolTip(_("Select a format for saving the image. \"Automatic\" means that the format will be decided based on the file extension (*.jpg is a JPEG, *.png is a PNG, ...). Another format will force the editor to use this format, whatever the file extension is."));
